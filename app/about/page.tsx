      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-blue-200/50">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-200/50">
              <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mb-3">
                <Globe className="h-5 w-5 text-blue-600" />
              </div>
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">Web Search</h3>
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">Image Search</h3>
              <p className="text-xs text-blue-700">
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">Video Search</h3>
              <p className="text-xs text-blue-700">
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">News Search</h3>
              <p className="text-xs text-blue-700">
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">Places Search</h3>
              <p className="text-xs text-blue-700">
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">Shopping Search</h3>
              <p className="text-xs text-blue-700">
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">Scholar Search</h3>
              <p className="text-xs text-blue-700">
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-1 text-sm">Patent Search</h3>
              <p className="text-xs text-blue-700">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-blue-200/50">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-4">
                <Search className="h-6 w-6 text-blue-600" />
              </div>
              <h3 className="font-semibold text-blue-800 mb-2">AI-Powered Reasoning</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-2">Multi-Source Search</h3>
              <p className="text-sm text-blue-700">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-2">Privacy Focused</h3>
              <p className="text-sm text-blue-700">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-2">Customizable Models</h3>
              <p className="text-sm text-blue-700">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-blue-200/50">
              ...
              <h3 className="font-semibold text-blue-800 mb-2">Intelligent Insights</h3>
              <p className="text-sm text-blue-700">
