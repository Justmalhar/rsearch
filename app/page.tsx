  ...
  return (
    <div className="flex-1 flex flex-col min-h-full">
      <main className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <div className="flex flex-col items-center space-y-4 mb-8">
          <Logo className="transform hover:scale-105 transition-transform duration-300" />
            <p className="text-blue-600 text-[12px] sm:text-sm font-small bg-blue-100/50 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full shadow-sm text-center max-w-[90vw] mx-auto whitespace-nowrap">
        ...
        <div className="mt-4 w-full max-w-2xl">
          <div className="relative group">
            <Meteors number={30} />
            <div className="relative flex flex-col gap-4 bg-white/95 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-blue-200/50 hover:border-blue-300/70 transition-all duration-300">
              {/* Search Input Area */}
              <div className="relative">
                <div 
                  className="absolute left-4 top-4 mt-4 text-blue-600"
                >
                  <svg 
                    width="18" 
                    height="18" 
                ...
                <Textarea 
                  ...
                  focus:border-blue-400 focus-visible:ring-2 focus-visible:ring-blue-500/50
                  rounded-2xl transition-all duration-300 shadow-inner
                  placeholder:text-blue-600/70 text-blue-800
              ...
              <div className="flex items-center justify-between px-2">
                <div className="flex gap-2 items-center">
                  ...
                  <Button
                    ...
                    className={`flex gap-2 border transition-colors shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 ${
                      enableQueryRefinement 
                        ? 'bg-blue-500 text-white hover:bg-blue-600 border-blue-500 hover:text-white' 
                        : 'text-blue-500 hover:bg-blue-100 hover:text-blue-700 border-blue-200/50'
                    }`}
                  >
                  ...
                  */}
                  {isDesktop ? (
                    <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen} >
                      <DropdownMenuTrigger asChild>
                        <Button 
                          variant="ghost" 
                          size="sm" 
                          className={`flex gap-2 border transition-colors shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 text-blue-500 hover:bg-blue-100 hover:text-blue-700 border-blue-200/50 rounded-full`}
                        >
                      ...
                      <DropdownMenuContent align="start" className="w-[600px] mt-2 p-4 bg-white border-blue-200" sideOffset={8}>
                        <div className="grid grid-cols-4 grid-rows-2">
                          {searchModes.map((mode) => (
                            <DropdownMenuItem
                              ...
                              className="flex flex-col items-start p-3 cursor-pointer hover:bg-blue-100/80 focus:bg-blue-100/80"
                            >
                              <div className="flex items-center gap-3">
                                <mode.icon className="h-5 w-5 text-blue-600 flex-shrink-0" />
                                <span className="font-medium text-blue-900">{mode.label}</span>
                              </div>
                              <p className="text-xs text-blue-600 leading-relaxed w-full">
                                {mode.description}
                              </p>
                            </DropdownMenuItem>
                          ))}
                    ...
                    <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
                      <DrawerTrigger asChild>
                        <Button variant="ghost" size="sm" className={`flex gap-2 border transition-colors shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 text-blue-500 hover:bg-blue-100 hover:text-blue-700 border-blue-200/50 rounded-full`}>
                          <Zap className="h-4 w-4" />
                          {searchMode 
                            ? searchModes.find(mode => mode.id === searchMode)?.label 
                            : 'Mode'
                      ...
                      <DrawerContent className="bg-white border-t border-blue-200">
                        <DrawerHeader>
                          <DrawerTitle className="text-lg font-medium text-blue-700">
                            Select Search Mode
                          </DrawerTitle>
                        </DrawerHeader>
                        <div className="p-4 space-y-4">
                          {searchModes.map((mode) => (
                            <button
                              key={mode.id}
                              type="button"
                              className="flex items-center gap-3 w-full p-3 hover:bg-blue-100/80 rounded-lg transition-colors"
                              onClick={() => {
                                setSearchMode(mode.id);
                            ...
                            >
                              ...
                              <div className="text-left">
                                <div className="font-medium text-blue-900">{mode.label}</div>
                                <div className="text-sm text-blue-600">{mode.description}</div>
                              </div>
                            </button>
                          ))}
                        </div>
                  ...
                  <Button
                    ...
                    className={`flex gap-2 border transition-colors shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 rounded-full ${
                      enableDeepResearch 
                        ? 'bg-blue-500 text-white hover:bg-blue-600 border-blue-500 hover:text-white' 
                        : 'text-blue-500 hover:bg-blue-100 hover:text-blue-700 border-blue-200/50'
                    }`}
        ...
        <div className="mt-8 text-center">
          <Link 
            href="/image" 
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 font-medium text-sm"
          >
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-blue-200/50">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-blue-50/50 rounded-xl">
                ...
                <h3 className="font-semibold text-blue-800 mb-1">Web Search</h3>
              ...
              <div className="text-center p-4 bg-blue-50/50 rounded-xl">
                <BookText className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                <h3 className="font-semibold text-blue-800 mb-1">Image Search</h3>
                <p className="text-xs text-blue-700">
                  Find visual content
                </p>
              </div>
              ...
              <div className="text-center p-4 bg-blue-50/50 rounded-xl">
                ...
                <h3 className="font-semibold text-blue-800 mb-1">Video Search</h3>
                <p className="text-xs text-blue-700">
                  Discover videos
                </p>
              </div>
              ...
              <div className="text-center p-4 bg-blue-50/50 rounded-xl">
                ...
                <h3 className="font-semibold text-blue-800 mb-1">News Search</h3>
                <p className="text-xs text-blue-700">
                  Latest news updates
                </p>
              </div>
              ...
              <div className="text-center p-4 bg-blue-50/50 rounded-xl">
                ...
                <h3 className="font-semibold text-blue-800 mb-1">Places Search</h3>
                <p className="text-xs text-blue-700">
              ...
              <div className="text-center p-4 bg-blue-50/50 rounded-xl">
                ...
                <h3 className="font-semibold text-blue-800 mb-1">Shopping Search</h3>
                <p className="text-xs text-blue-700">
                  Products & deals
                </p>
              </div>
              ...
              <div className="text-center p-4 bg-blue-50/50 rounded-xl">
                ...
                <h3 className="font-semibold text-blue-800 mb-1">Scholar Search</h3>
                <p className="text-xs text-blue-700">
                  Academic papers
                </p>
              </div>
              ...
              <div className="text-center p-4 bg-blue-50/50 rounded-xl">
                ...
                <h3 className="font-semibold text-blue-800 mb-1">Patent Search</h3>
                <p className="text-xs text-blue-700">
                  Patent databases
                </p>
              </div>
        ...
        <section className="mt-12 max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold text-blue-800 mb-2">Advanced Reasoning</h3>
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold text-blue-800 mb-2">8 Search Modes</h3>
              <p className="text-sm text-blue-700">
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold text-blue-800 mb-2">Free & Open</h3>
              <p className="text-sm text-blue-700">
      ...
      <footer className="mt-auto relative">
        <div className="absolute inset-0 bg-gradient-to-t from-blue-300/40 via-blue-200/30 to-transparent pointer-events-none" />
        <div className="relative max-w-4xl mx-auto px-4 py-8 md:py-12">
          <div className="flex flex-col items-center gap-4">
            {/* Links Section */}
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm font-medium pb-4 border-b border-blue-200/30">
              <Link 
                href="/terms" 
                className="text-blue-800/90 hover:text-blue-900 transition-colors  hover:scale-105 transform duration-200"
              >
                Terms
              </Link>
            ...
            <div className="flex flex-row items-center gap-4 text-sm pt-2">
              <a 
                ...
                className="text-blue-700/90 hover:text-blue-800 transition-colors  hover:scale-105 transform duration-200 whitespace-nowrap hover:bg-blue-100/50 px-3 py-1 rounded-full"
              >
              ...
              <a 
                ...
                className="hidden md:flex text-blue-700/90 hover:text-blue-800 transition-colors  hover:scale-105 transform duration-200 items-center gap-2 hover:bg-blue-100/50 px-3 py-1 rounded-full"
              >
                <svg 
                  className="w-4 h-4" 
                  viewBox="0 0 24 24" 
