              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <Textarea
                    ...
                    className="min-h-[100px] resize-none border-2 border-gray-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-100 rounded-2xl text-base p-4 transition-all duration-300 bg-white/50 backdrop-blur-sm"
                ...
                >
                  ...
                  <div>
                    ...
                    <Select value={aspectRatio} onValueChange={setAspectRatio} disabled={isGenerating}>
                      <SelectTrigger className="h-12 border-2 border-gray-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-100 rounded-full bg-white/50 backdrop-blur-sm text-base">
                        <SelectValue />
                      </SelectTrigger>
                ...
                >
                  <Button
                    ...
                    className="w-full h-14 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    size="lg"
                  >
                    {isGenerating ? (
                      <div className="flex items-center gap-3">
              ...
              <Card className="backdrop-blur-xl bg-white/80 border-0 shadow-xl rounded-2xl overflow-hidden">
                <CardContent className="p-12 text-center">
                  ...
                  <motion.div
                    ...
                    className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-100 to-orange-200 border border-orange-300 rounded-full"
                  >
            ...
            >
              ...
              {enhancedPrompt && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.6 }}
                  className="mb-8 max-w-3xl mx-auto p-6 bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-2xl backdrop-blur-sm"
                >
              ...
              <div className={`grid gap-6 ${images.length === 1 ? 'justify-center max-w-3xl mx-auto' : 'grid-cols-1 md:grid-cols-2'}`}>
                {images.map((image, index) => (
                  <motion.div
                    ...
                    className="group"
                  >
                    <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-500 rounded-2xl bg-white/80 backdrop-blur-xl">
                        ...
                        <div className="relative">
                          ...
                          >
                            <motion.div
                              ...
                              className="flex items-center gap-2 text-white font-semibold px-4 py-3 rounded-full bg-black/50 backdrop-blur-sm border border-white/20"
                            >
                              <Download className="h-5 w-5" />
                              <span className="text-base">Download Image</span>
                            </motion.div>
                          </motion.div>
                        </div>
                      </CardContent>
