      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {searchFeatures.map((feature, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-blue-200/50 hover:shadow-xl transition-shadow">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {aiFeatures.map((feature, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-blue-200/50">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-blue-200">
                    <th className="py-4 px-4 font-semibold text-blue-800">Feature</th>
                    <th className="py-4 px-4 font-semibold text-blue-800">rSearch</th>
                    <th className="py-4 px-4 font-semibold text-blue-800">Perplexity</th>
                    <th className="py-4 px-4 font-semibold text-blue-800">Google</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-blue-100">
                    <td className="py-3 px-4 font-medium text-blue-800">AI Reasoning</td>
        ...
        <section className="text-center">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-blue-200/50">
            ...
            <Link 
              href="/" 
              className="inline-flex items-center gap-2 px-8 py-4 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 font-medium text-lg"
            >
